...
async function testSpecificCalendar() {
  ...
  try {
    ...
    try {
      ...
      console.log(
        "❌ Cannot access fn24vinson@gmail.com calendar:",
        error.message
      );
      console.log(
        "This is normal if you don't have access to this calendar from your current account.\n"
      );
    }

    // Test primary calendar (which we know works)
    console.log(
      "2. Using primary calendar (vinsonfn24@gmail.com) for integration..."
    );
