...
import { countExecutionAttemptsForJob, getJobInspection, hasSuccessfulExecutionAttempt, insertExecutionAttempt, updateJobStatus } from "../storage/repositories.js";
function toExecutionAttemptId(jobId, attemptNumber) {
...
export async function executeJob(db, jobId, options) {
