...
/**
 * Test the automated Field Nation login with automatic code retrieval
 */
async function testLoginFnAuto() {
  let browser;

  try {
    console.log("🧪 Starting Field Nation login test...");
    ...
    */
    ...
    // Check results
    if (result.success) {
      console.log("🎉 TEST PASSED: Login completed successfully!");
...
// Run the test
testLoginFnAuto().catch(console.error);
